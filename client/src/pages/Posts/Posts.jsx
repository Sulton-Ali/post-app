...
function Posts() {
  ...
  const loadPosts = () => {
    postService
      ...
      .catch((e) => setToast({
        show: true,
        content: "Postni olishda xatolik yuz berdi. " + e.message
      }));
  }
  ...
  const deletePost = (id) => {
    postService.deletePostById(id)
      ...
      .catch(e => {
        setToast({
          show: true,
          content: "Postni o`chirishda xatolik yuz berdi. " + e.message
        });
      });
  }

  const onPostUpdated = (message) => {
    handleClose();
    loadPosts();
    setToast({
      show: true, content: message
    })
  }
